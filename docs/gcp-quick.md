...
To learn how to access your cluster, refer to [Accessing a cluster](gcp-clusters-access.md).

To learn how to use Cloudbreak to manage your cluster, refer to [Managing and monitoring clusters](gcp-clusters-manage.md).