...
1. Download the latest Cloudbreak deployer image to your local machine:
    ...
    <pre><small>curl -O https://public-repo-1.hortonworks.com/HDP/cloudbreak/cloudbreak-deployer-250-2018-04-05.img</small></pre>

2. Set the following environment variables for the OpenStack image import:

    <pre><small>export CBD_LATEST_IMAGE=cloudbreak-deployer-250-2018-04-05.img
export OS_IMAGE_NAME=cloudbreak-deployer-250-2018-04-05.img
