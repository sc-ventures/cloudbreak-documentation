...
[Generate a new SSH key pair](faq.md#generate-ssh-key-pair) or use an existing SSH key pair, and upload it to your OpenStack account. You must select it when launching the VM.  
