...
| CB_DEFAULT_GATEWAY_CIDR |  | CIDR address range which is used by Cloudbreak to communicate with its managed clusters. For more information, refer to [Restricting Inbound Access to Clusters](security-cb-inbound.md). |
