...
Before launching Cloudbreak on Azure, review and meet the [prerequisites](https://hortonworks.github.io/cloudbreak-documentation/latest/). Next, follow the steps below.  
...
**Related links**  
[Toubleshooting](https://hortonworks.github.io/cloudbreak-documentation/latest/)   
