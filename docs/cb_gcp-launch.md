...
[Generate a new SSH key pair](https://hortonworks.github.io/cloudbreak-documentation/latest/) or use an existing SSH key pair. You will be required to provide it when launching the VM. 
...
Before launching Cloudbreak on Google Cloud, review and meet the [prerequisites](https://hortonworks.github.io/cloudbreak-documentation/latest/). Next, follow the steps below.  
